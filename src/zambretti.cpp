...
String ZambrettiForecaster::calculateForecast(float currentPressureHpa, float pastPressureHpa, int month) {
...
String ZambrettiForecaster::getZambrettiText(int code) {
    switch (code) {
