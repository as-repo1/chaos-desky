...
void BleWifiProvisioner::onConnect(BLEServer* pServer) {
...
void BleWifiProvisioner::onDisconnect(BLEServer* pServer) {
...
void BleWifiProvisioner::sendReply(const String& msg) {
...
void BleWifiProvisioner::onWrite(BLECharacteristic* pCharacteristic) {
